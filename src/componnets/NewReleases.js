...
const NewReleases = () => {
  ...
  const {data: newmovies, isPendingnew, errornew}=useFetch(apis.movies+apiKey+"&sort_by=primary_release_date.desc&primary_release_date.gte=1900-01-01&primary_release_date.lte="+todaydate+"&with_release_type=2%7C3");
